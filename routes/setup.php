...
Route::get('/purchase-code', [SetupController::class, 'purchase'])->name('installation.purchase');
Route::post('/purchase-code', [SetupController::class, 'purchaseCode'])->name('installation.purchase_code');
