...
jQuery(function ($) {
    ...
    sidebar?.addEventListener("mouseenter", function () {
        $('#favicon_backend').addClass('d-none');       
    ...
    sidebar?.addEventListener("mouseleave", function () {
        $('#favicon_backend').addClass('d-none');
        if (this.classList.contains("collapse")) {
            console.log('mouse leave'+this.classList);
            $('#favicon_backend').removeClass('d-none');
            allDivider.forEach((item) => {
                item.textContent = "-";
    ...
    var setDarkMode = (active = false) => {
        ...
        if (active) {
            ...
            setCookie("theme", "dark", 30*24);
        } else {
            wrapper.setAttribute("data-bs-theme", "light");
            setCookie("theme", "light", 30*24);
        }
    };
