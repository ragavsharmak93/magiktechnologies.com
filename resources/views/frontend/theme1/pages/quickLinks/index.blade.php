...
@section('title')
    {{ $page->collectLocalization('title') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-xxl-5 col-xl-8">
                        <div class="text-center">
                            ...
                            <h2 class="h3 fw-bold clr-neutral-87 mt-4 mb-0"> {{ $page->collectLocalization('title') }}</h2>
                        </div>
                    </div>
                    <div class="col-xl-8">
