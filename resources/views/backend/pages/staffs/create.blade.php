                    ...
                    <div class="tt-page-header">
                        <div class="d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title mb-3 mb-lg-0">
                                <h1 class="h4 mb-lg-1">{{ localize('Add New Staff') }}</h1>
                                <ol class="breadcrumb breadcrumb-angle text-muted">
                                    ...
                                    <li class="breadcrumb-item">{{ localize('New Staff') }}</li>
                                </ol>
                            </div>
                            <div class="tt-action">
                    ...
                    <form action="{{ route('admin.staffs.store') }}" method="POST" class="pb-650">
                        ...
                        <div class="card mb-4" id="section-1">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    <label for="name" class="form-label">{{ localize('Staff Name') }} <x-required-star/> </label>
                                ...
                                <div class="mb-4">
                                    <label for="email" class="form-label">{{ localize('Staff Email') }} <x-required-star/> </label>
                                ...
                                <div class="mb-4">
                                    <label for="password" class="form-label">{{ localize('Password') }} <x-required-star/> </label>
