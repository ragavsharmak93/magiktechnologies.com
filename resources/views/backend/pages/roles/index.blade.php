                    ...
                    <div class="tt-page-header">
                        <div class="d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title mb-3 mb-lg-0">
                                <h1 class="h4 mb-lg-1">{{ localize('Roles & Permissions') }}</h1>
                                <ol class="breadcrumb breadcrumb-angle text-muted">
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('writebot.dashboard') }}">{{ localize('Dashboard') }}</a>
                                    </li>
                                    <li class="breadcrumb-item">{{ localize('Roles') }}</li>
                                </ol>
                            </div>
                            <div class="tt-action">
                                @if (isAdmin())
                                <a href="{{ route('admin.restore-permissions') }}" class="btn btn-warning"><i
                                        data-feather="refresh-cw"></i> {{ localize('Reset Permission') }}</a>
                            @endif
...
@section('scripts')
    <script>
        ...
        function updateStatus(el) {
            ...
            $.post('{{ route('admin.role.updateStatus') }}', {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    is_active: is_active
                },
