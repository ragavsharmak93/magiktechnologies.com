                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card mb-4" id="section-1">
                                @include('backend.pages.appearance.homepage.inc._images')
                            </div>
                        </div>
                    </div>

                    <form action="{{ route('admin.appearance.homepage.store-feature-images') }}" method="POST"
                                    ...
                                    <div class="tt-image-drop rounded">
                                        ...
                                        <div class="tt-product-thumb show-selected-files mt-3">
                                            <div class="avatar avatar-xl cursor-pointer choose-media"
                                                ...
                                                onclick="showMediaManager(this)" data-selection="multi">
