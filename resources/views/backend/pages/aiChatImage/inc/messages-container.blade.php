@if (!is_null($conversation))
    ...
    <div class="tt-conversation p-3 tt-custom-scrollbar">
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="msg-wrapper">
                                ...
                                <div
                                    ...
                                    {!! $result !!}
                                    <a href="{{staticAsset($message->file_path)}}" target="_blank" rel="noopener noreferrer">

                                        @if ($message->storage_type == 'aws')
                                            <img src="{{$message->file_path}}"  width="256" alt="">

                                        @else
                                        <img src="{{staticAsset($message->file_path)}}"  width="256" alt="">
                                        @endif
                                </a>
        ...
        <!-- single chat expert start -->
        <div class="d-flex justify-content-start mb-4 tt-message-wrap new-msg-loader single-chat-wrapper-copy d-none">
    ...
    <div class="mt-auto text-center border-top d-flex justify-content-between align-items-end">
        <form class="p-3 d-block w-100" id="image_chat" data-category_id="{{$chatExpert->id}}">
