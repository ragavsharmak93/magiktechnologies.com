...
@section('title')
    {{ localize('AI Writer') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="tt-page-header">
                        <div class="d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title mb-3 mb-lg-0">
                                <h1 class="h4 mb-lg-1">{{ localize('AI Writer') }}</h1>
                                <ol class="breadcrumb breadcrumb-angle text-muted">
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('writebot.dashboard') }}">{{ localize('Dashboard') }}</a>
                                    </li>
                                   
                                    <li class="breadcrumb-item">{{ localize('AI Writer') }}</li>
                                </ol>
                            </div>
                            <div class="tt-action">
                            </div>
                            ...
                            <div class="col-12">
                                <div class="tt-article-generate">
                                    ...
                                    <form action="" method="POST" class="generate-contents-form"
                                        data-url={{ route('aiRewriter.generate') }}>
                                        @csrf
                                        ...
                                        <div class="mb-4"> 
                                            ...
                                            <label for="about" class="form-label"><span
                                                class="fw-bold tt-promot-number fw-bold fs-4 me-2">2.</span>{{ localize('Input your content ') }}<span
                                                class="text-danger ms-1">*</span></label>
                                            <textarea class="form-control" name="about" id="about" rows="4"
                                            placeholder="{{ localize('Type here') }}"></textarea>
                                        </div>
                                            ...
                                            <div class="d-flex flex-column">
                                                <div
                                                    ...
                                                    <label class="form-label cursor-pointer"><span
                                                            class="fw-bold tt-promot-number fw-bold fs-4 me-2"></span>{{ localize('Advance Options') }}<span
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="form-input">
                                                                    ...
                                                                    <input class="form-control" type="number"
                                                                        ...
                                                                        @if (isCustomer()) max="{{ auth()->user()->this_month_available_words }}" @endif>
                                                                </div>
                                                            </div>
                ...
                <div class="col-xl-7 col-lg-7 mt-4 mt-md-0">
                    <div class="tt-generate-text">
                        <div class="row">
                            <div class="col-12">
                                <div
                                    class="card flex-column h-100 {{ auth()->user()->user_type != 'customer' ? 'mt-2' : '' }}">
...
@section('scripts')
    @include('backend.pages.aiWriter.inc.rewriter-scripts')
    @include('backend.pages.templates.inc.rewrite-scripts')
@endsection
