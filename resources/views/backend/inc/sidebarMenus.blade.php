<ul class="tt-side-nav">
    ...
    @canany(['open_ai', 'fine_tune', 'voice_settings', 'homepage', 'about_us_page', 'header', 'footer',
        ...
        <!-- system settings -->
        @php
            $settingsActiveRoutes = ['admin.generalSettings', 'admin.orderSettings', 'admin.timeslot.edit', 'admin.languages.index', 'admin.languages.edit', 'admin.currencies.index', 'admin.currencies.edit', 'admin.languages.localizations', 'admin.smtpSettings.index', 'admin.offline-payment.index', 'admin.cronJobList', 'admin.invoice-settings.index'];
        @endphp
